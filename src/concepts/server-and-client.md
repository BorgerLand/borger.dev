...
- The client's [**state**](./io-state.md#output) is said to be a _prediction_. Because of network latency, the client needs to try to predict what the server will send before the client receives anything.
