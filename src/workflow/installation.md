...
- [**Bash**](https://www.gnu.org/software/bash/): Required to run Borger's CLI tool. Installing it depends on your operating system:
  ...
  - macOS:
    ...
    2.  Check your Bash version in the terminal: `bash --version`. If it outputs version 3.2, congrats, your Bash is 20 years out of date.
    3.  Update to a modern one with `brew install bash`
    4.  Check the version again to be on the safe side. If it's still stuck at 3.2, restart the terminal.
...
- [**Visual Studio Code**](https://code.visualstudio.com/Download) - Technically any IDE will do the job (or even a plain text editor if you hate being productive), but Borger is preconfigured to work with VSCode.
  ...
  - [**Even Better TOML**](https://marketplace.visualstudio.com/items?itemName=tamasfe.even-better-toml) - Syntax highlighting for TOML
