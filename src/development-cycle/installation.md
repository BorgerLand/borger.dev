...
This installs the latest `borger` CLI tool, as well as Rustup, Node Version Manager (NVM), cargo-watch, and wasm-pack if they can't be found. If asked upon completion, close and restart the terminal. Do note the security implications of downloading and installing several programs from the internet.
